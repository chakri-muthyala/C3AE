...
#class c3ae_plain:
#    def __init__(self,height=64, width=64, channels=3):
#        self.height = height
#        self.width = width
...
#    def __call__(self,):
#            #c3ae naive net
#        input_image = Input(shape=[self.height, self.width, self.channels])
#        #conv1
...
#        age = Dense(1, activation=softmax, kernel_regularizer=regularizers.l1(0), name="W2")(feats)
#        pmodel = Model(input=input_image, output=[age, feats])
#        
#        return pmodel
